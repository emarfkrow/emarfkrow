...
let MTokuyakGridColumns = [
    ...
    Column.text('EIGYOKBN', Messages['MTokuyakGrid.eigyokbn'], 20, '', null),
    Column.text('YURYOKUKBN', Messages['MTokuyakGrid.yuryokukbn'], 10, '', null),
    Column.text('GYOSHU-KBN', Messages['MTokuyakGrid.gyoshuKbn'], 20, '', null),
    ...
    Column.text('TOUROKUBI', Messages['MTokuyakGrid.tourokubi'], 80, '', null),
    Column.text('TORIHIKI-KBN', Messages['MTokuyakGrid.torihikiKbn'], 10, '', null),
    ...
    Column.text('FAXKBN', Messages['MTokuyakGrid.faxkbn'], 10, '', null),
