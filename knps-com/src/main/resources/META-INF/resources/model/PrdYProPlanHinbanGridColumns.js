...
let PrdYProPlanHinbanGridColumns = [
    ...
    Column.refer('PRO_HINBAN', Messages['PrdYProPlanHinbanGrid.proHinban'], 250, 'primaryKey', 'PRO_HINMEI'),
    ...
    Column.refer('PARENT_HINBAN', Messages['PrdYProPlanHinbanGrid.parentHinban'], 250, '', 'PARENT_HINMEI'),
