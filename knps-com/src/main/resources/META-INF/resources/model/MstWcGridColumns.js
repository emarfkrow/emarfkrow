...
let MstWcGridColumns = [
    ...
    Column.select('ROUTING_CODE', Messages['MstWcGrid.routingCode'], 100, '', { json: 'MstCodeValueSearch.json', paramkey: 'code_nm', value: 'CODE_VALUE', label: 'CODE_VALUE_MEI' }),
    ...
    Column.select('WS_CODE', Messages['MstWcGrid.wsCode'], 40, '', { json: 'MstCodeValueSearch.json', paramkey: 'code_nm', value: 'CODE_VALUE', label: 'CODE_VALUE_MEI' }),
    Column.select('COST_CENTER_CODE', Messages['MstWcGrid.costCenterCode'], 100, '', { json: 'MstCodeValueSearch.json', paramkey: 'code_nm', value: 'CODE_VALUE', label: 'CODE_VALUE_MEI' }),
    ...
    Column.select('SUB_INV_CODE', Messages['MstWcGrid.subInvCode'], 100, '', { json: 'MstCodeValueSearch.json', paramkey: 'code_nm', value: 'CODE_VALUE', label: 'CODE_VALUE_MEI' }),
