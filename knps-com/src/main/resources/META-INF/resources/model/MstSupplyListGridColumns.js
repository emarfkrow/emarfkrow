...
let MstSupplyListGridColumns = [
    ...
    Column.cell('MAN_HINBAN', Messages['MstSupplyListGrid.manHinban'], 250, 'primaryKey', null),
    Column.cell('ROUTING', Messages['MstSupplyListGrid.routing'], 20, 'primaryKey', null),
    Column.cell('SUPPLY_HINBAN', Messages['MstSupplyListGrid.supplyHinban'], 250, 'primaryKey', null),
