...
let MstLocationGridColumns = [
    ...
    Column.select('SUB_INV_CODE', Messages['MstLocationGrid.subInvCode'], 100, '', { json: 'MstCodeValueSearch.json', paramkey: 'code_nm', value: 'CODE_VALUE', label: 'CODE_VALUE_MEI' }),
    ...
    Column.text('STORE_MAN_ID', Messages['MstLocationGrid.storeManId'], 100, '', null),
];
