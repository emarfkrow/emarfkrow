...
let MfgKanbanDetGridColumns = [
    ...
    Column.select('FOR_PRO_LOCATION_CODE', Messages['MfgKanbanDetGrid.forProLocationCode'], 100, '', { json: 'MstCodeValueSearch.json', paramkey: 'code_nm', value: 'CODE_VALUE', label: 'CODE_VALUE_MEI' }),
    ...
    Column.select('PRO_LOCATION_CODE', Messages['MfgKanbanDetGrid.proLocationCode'], 100, '', { json: 'MstCodeValueSearch.json', paramkey: 'code_nm', value: 'CODE_VALUE', label: 'CODE_VALUE_MEI' }),
