...
let MstHinbanGridColumns = [
    ...
    Column.select('UNIT_CODE', Messages['MstHinbanGrid.unitCode'], 20, '', { json: 'MstCodeValueSearch.json', paramkey: 'code_nm', value: 'CODE_VALUE', label: 'CODE_VALUE_MEI' }),
    Column.select('ACCOUNT_CODE', Messages['MstHinbanGrid.accountCode'], 50, '', { json: 'MstCodeValueSearch.json', paramkey: 'code_nm', value: 'CODE_VALUE', label: 'CODE_VALUE_MEI' }),
    ...
    Column.select('HINBAN_OPE_CODE', Messages['MstHinbanGrid.hinbanOpeCode'], 100, '', { json: 'MstCodeValueSearch.json', paramkey: 'code_nm', value: 'CODE_VALUE', label: 'CODE_VALUE_MEI' }),
