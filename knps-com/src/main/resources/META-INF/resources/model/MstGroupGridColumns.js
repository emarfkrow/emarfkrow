...
let MstGroupGridColumns = [
    ...
    Column.select('DIVISION_CODE', Messages['MstGroupGrid.divisionCode'], 100, '', { json: 'MstCodeValueSearch.json', paramkey: 'code_nm', value: 'CODE_VALUE', label: 'CODE_VALUE_MEI' }),
