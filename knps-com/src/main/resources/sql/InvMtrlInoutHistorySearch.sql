SELECT
    ...
    , (SELECT r3."SUP_NAME" FROM MST_SUPPLIER r3 WHERE r3."SUP_CODE" = a."RECEIPT_SUP_CODE") AS "RECEIPT_SUP_NAME"
    , (SELECT r4."ITEM" FROM MST_HINBAN r4 WHERE r4."HINBAN" = a."ISSUE_HINBAN") AS "ISSUE_ITEM"
FROM
