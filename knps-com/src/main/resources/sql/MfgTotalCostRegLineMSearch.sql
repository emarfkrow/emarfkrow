...
WHERE
    ...
    AND a."GROSS_SUM_COST_FIRST" = :gross_sum_cost_first 
    AND a."GROSS_SUM_COST_SECOND" = :gross_sum_cost_second 
    AND a."TOTAL_GROSS_SUM_COST" = :total_gross_sum_cost 
    AND a."GROSS_SUM_UNIT_SUPPLY" = :gross_sum_unit_supply 
    AND a."T_GROSS_SUM_COST_FIRST" = :t_gross_sum_cost_first 
    AND a."T_GROSS_SUM_COST_SECOND" = :t_gross_sum_cost_second 
    AND a."T_TOTAL_GROSS_SUM_COST" = :t_total_gross_sum_cost 
    AND a."T_GROSS_SUM_UNIT_SUPPLY" = :t_gross_sum_unit_supply 
ORDER BY
