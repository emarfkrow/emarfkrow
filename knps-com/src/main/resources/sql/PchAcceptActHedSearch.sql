SELECT
    ...
    , (SELECT r3."UNIT_NAME" FROM MST_UNIT r3 WHERE r3."UNIT_CODE" = a."UNIT_CODE") AS "UNIT_NAME"
    , (SELECT r4."TAX_NAME" FROM MST_TAX r4 WHERE r4."TAX_CODE" = a."TAX_CODE") AS "TAX_NAME"
    , (SELECT r5."ACCOUNT_NAME" FROM MST_ACCOUNT_CODE r5 WHERE r5."ACCOUNT_CODE" = a."ACCOUNT_CODE") AS "ACCOUNT_NAME"
FROM
