SELECT
      a.*
    , (SELECT r2.ROUTING_NAME FROM MST_PROC r2 WHERE r2.ROUTING_CODE = a."ROUTING_CODE") AS ROUTING_NAME
    , (SELECT r3.WS_NAME FROM MST_WS r3 WHERE r3.WS_CODE = a."WS_CODE") AS WS_NAME
    , (SELECT r4.COST_CENTER_NAME FROM MST_COST_CENTER r4 WHERE r4.COST_CENTER_CODE = a."COST_CENTER_CODE") AS COST_CENTER_NAME
    , (SELECT r5.SUB_INV_NAME FROM MST_SUBINV r5 WHERE r5.SUB_INV_CODE = a."SUB_INV_CODE") AS SUB_INV_NAME
FROM
    MST_WC_BK a 
WHERE
    1 = 1 
