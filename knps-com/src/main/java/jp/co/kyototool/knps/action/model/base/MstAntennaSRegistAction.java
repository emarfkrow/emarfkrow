 ...
 * @author emarfkrow
 */
public class MstAntennaSRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            // 主キーが不足していたらINSERT
            boolean isNew = false;
            if (jp.co.golorp.emarf.lang.StringUtil.isNullOrBlank(e.getReaderNo())) {
                isNew = true;
            }
            if (jp.co.golorp.emarf.lang.StringUtil.isNullOrBlank(e.getAntennaNo())) {
                isNew = true;
            }
