 ...
 * @author emarfkrow
 */
public class PrdDailyProPlan implements IEntity {
    ...
    public static PrdDailyProPlan get(final Object param1) {
        ...
        return Queries.get(sql, params, PrdDailyProPlan.class);
    }

    /**
     * PRD_DAILY_PRO_PLAN追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // PRD_DAILY_PRO_PLANの登録
        String sql = "UPDATE PRD_DAILY_PRO_PLAN\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM PRD_DAILY_PRO_PLAN WHERE " + getWhere();
