 ...
 * @author emarfkrow
 */
public class MfgTotalResultM implements IEntity {
     ...
     * @param param5 OPE_DETAIL
     * @param param6 RESULT_DATE
     * @return MFG_TOTAL_RESULT_M
     */
    public static MfgTotalResultM get(final Object param1, final Object param2, final Object param3, final Object param4, final Object param5, final Object param6) {
        ...
        String sql = "SELECT * FROM MFG_TOTAL_RESULT_M WHERE " + String.join(" AND ", whereList);
        ...
        params.put("ope_detail", param5);
        params.put("result_date", param6);

        return Queries.get(sql, params, MfgTotalResultM.class);
    }

    /**
     * MFG_TOTAL_RESULT_M追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        String sql = "INSERT INTO MFG_TOTAL_RESULT_M(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT LPAD (CASE WHEN MAX(e.RESULT_DATE) IS NULL THEN 0 ELSE MAX(e.RESULT_DATE) * 1 END + 1, 6, '0') AS RESULT_DATE FROM MFG_TOTAL_RESULT_M e WHERE e.RESULT_DATE < '999999'";
        ...
        whereList.add("e.OPE_DETAIL = :ope_detail");
        ...
        params.put("opeDetail", this.opeDetail);

        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, params);
        Object o = mapList.get(0).get("RESULT_DATE");

        this.setResultDate(o);
    }

    /**
     * MFG_TOTAL_RESULT_M更新
     *
     * @param now システム日時
     * @param id 更新者
     * @return 更新件数
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // MFG_TOTAL_RESULT_Mの登録
        String sql = "UPDATE MFG_TOTAL_RESULT_M\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        // MFG_TOTAL_RESULT_Mの削除
        String sql = "DELETE FROM MFG_TOTAL_RESULT_M WHERE " + getWhere();
