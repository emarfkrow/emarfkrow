...
/**
 * INV_STOCK_MANAGEMENT_INV一覧登録
 *
 * @author emarfkrow
 */
public class InvStockManagementInvSRegistAction extends BaseAction {

    /** INV_STOCK_MANAGEMENT_INV一覧登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("InvStockManagementInvGrid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            InvStockManagementInv e = FormValidator.toBean(InvStockManagementInv.class.getName(), gridRow);
