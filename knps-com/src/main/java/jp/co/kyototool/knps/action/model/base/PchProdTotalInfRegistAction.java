...
/**
 * PCH_PROD_TOTAL_INF登録
 *
 * @author emarfkrow
 */
public class PchProdTotalInfRegistAction extends BaseAction {

    /** PCH_PROD_TOTAL_INF登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {

        Map<String, Object> map = new HashMap<String, Object>();

        PchProdTotalInf e = FormValidator.toBean(PchProdTotalInf.class.getName(), postJson);
