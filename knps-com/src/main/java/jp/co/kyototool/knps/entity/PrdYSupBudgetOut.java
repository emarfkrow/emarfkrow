 ...
 * @author emarfkrow
 */
public class PrdYSupBudgetOut implements IEntity {
    ...
    public static PrdYSupBudgetOut get(final Object param1, final Object param2, final Object param3, final Object param4) {
        ...
        return Queries.get(sql, params, PrdYSupBudgetOut.class);
    }

    /**
     * PRD_Y_SUP_BUDGET_OUT追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        String sql = "INSERT INTO PRD_Y_SUP_BUDGET_OUT(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // PRD_Y_SUP_BUDGET_OUTの登録
        String sql = "UPDATE PRD_Y_SUP_BUDGET_OUT\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM PRD_Y_SUP_BUDGET_OUT WHERE " + getWhere();
