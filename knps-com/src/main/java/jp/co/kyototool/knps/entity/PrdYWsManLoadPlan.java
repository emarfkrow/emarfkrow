 ...
 * @author emarfkrow
 */
public class PrdYWsManLoadPlan implements IEntity {
     ...
     */
    public static PrdYWsManLoadPlan get(final Object param1, final Object param2, final Object param3, final Object param4) {
        ...
        String sql = "SELECT * FROM PRD_Y_WS_MAN_LOAD_PLAN WHERE " + String.join(" AND ", whereList);
        ...
        return Queries.get(sql, params, PrdYWsManLoadPlan.class);
    }

    /**
     * PRD_Y_WS_MAN_LOAD_PLAN追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        String sql = "INSERT INTO PRD_Y_WS_MAN_LOAD_PLAN(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT LPAD (CASE WHEN MAX(e.WS_CODE) IS NULL THEN 0 ELSE MAX(e.WS_CODE) * 1 END + 1, 4, '0') AS WS_CODE FROM PRD_Y_WS_MAN_LOAD_PLAN e WHERE e.WS_CODE < '9999'";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // PRD_Y_WS_MAN_LOAD_PLANの登録
        String sql = "UPDATE PRD_Y_WS_MAN_LOAD_PLAN\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM PRD_Y_WS_MAN_LOAD_PLAN WHERE " + getWhere();
