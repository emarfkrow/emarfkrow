...
/**
 * MFG_TOTAL_COST_REG_LINE_I1登録
 *
 * @author emarfkrow
 */
public class MfgTotalCostRegLineI1RegistAction extends BaseAction {

    /** MFG_TOTAL_COST_REG_LINE_I1登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {

        Map<String, Object> map = new HashMap<String, Object>();

        MfgTotalCostRegLineI1 e = FormValidator.toBean(MfgTotalCostRegLineI1.class.getName(), postJson);
