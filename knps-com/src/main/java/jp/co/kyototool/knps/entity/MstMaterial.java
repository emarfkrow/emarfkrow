 ...
 * @author emarfkrow
 */
public class MstMaterial implements IEntity {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("MATERIAL_NAME")
    public String getMaterialName() {
        return this.materialName;
    }

    /**
     * @param o MATERIAL_NAME
     */
    public void setMaterialName(final Object o) {
        if (!jp.co.golorp.emarf.lang.StringUtil.isNullOrBlank(o)) {
            this.materialName = String.valueOf(o.toString());
        } else {
    ...
    public static MstMaterial get(final Object param1) {
        ...
        params.put("material", param1);

        return Queries.get(sql, params, MstMaterial.class);
    }
    ...
    private void numbering() {
        ...
        Object o = mapList.get(0).get("MATERIAL");
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // MST_MATERIALの登録
        String sql = "UPDATE MST_MATERIAL\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        // MST_MATERIALの削除
        String sql = "DELETE FROM MST_MATERIAL WHERE " + getWhere();
