 ...
 * @author emarfkrow
 */
public class PrdSalesTargetYear implements IEntity {
     ...
     */
    public static PrdSalesTargetYear get(final Object param1, final Object param2, final Object param3, final Object param4) {
        ...
        String sql = "SELECT * FROM PRD_SALES_TARGET_YEAR WHERE " + String.join(" AND ", whereList);
        ...
        return Queries.get(sql, params, PrdSalesTargetYear.class);
    }

    /**
     * PRD_SALES_TARGET_YEAR追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        String sql = "INSERT INTO PRD_SALES_TARGET_YEAR(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT LPAD (CASE WHEN MAX(e.\"SALES_HINBAN\") IS NULL THEN 0 ELSE MAX(e.\"SALES_HINBAN\") * 1 END + 1, 20, '0') AS \"SALES_HINBAN\" FROM PRD_SALES_TARGET_YEAR e WHERE e.\"SALES_HINBAN\" < '99999999999999999999'";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // PRD_SALES_TARGET_YEARの登録
        String sql = "UPDATE PRD_SALES_TARGET_YEAR\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM PRD_SALES_TARGET_YEAR WHERE " + getWhere();
