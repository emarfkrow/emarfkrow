...
/**
 * INV_STOCK_MTRL_MNG一覧削除
 *
 * @author emarfkrow
 */
public class InvStockMtrlMngSDeleteAction extends BaseAction {

    /** INV_STOCK_MTRL_MNG一覧削除処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("InvStockMtrlMngGrid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            InvStockMtrlMng e = FormValidator.toBean(InvStockMtrlMng.class.getName(), gridRow);
            if (e.delete() != 1) {
                throw new OptLockError("error.cant.delete");
            }
        }
