 ...
 * @author emarfkrow
 */
public class InvStockToolMngHed implements IEntity {
     ...
     */
    public static InvStockToolMngHed get(final Object param1, final Object param2, final Object param3) {
        ...
        String sql = "SELECT * FROM INV_STOCK_TOOL_MNG_HED WHERE " + String.join(" AND ", whereList);
        ...
        return Queries.get(sql, params, InvStockToolMngHed.class);
    }

    /**
     * INV_STOCK_TOOL_MNG_HED追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // INV_STOCK_TOOL_MNG_HEDの登録
        String sql = "UPDATE INV_STOCK_TOOL_MNG_HED\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM INV_STOCK_TOOL_MNG_HED WHERE " + getWhere();
