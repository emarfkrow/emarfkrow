 ...
 * @author emarfkrow
 */
public class PrdYProPlanCondition implements IEntity {
    ...
    public static PrdYProPlanCondition get(final Object param1, final Object param2) {
        ...
        return Queries.get(sql, params, PrdYProPlanCondition.class);
    }

    /**
     * PRD_Y_PRO_PLAN_CONDITION追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        String sql = "INSERT INTO PRD_Y_PRO_PLAN_CONDITION(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT LPAD (CASE WHEN MAX(e.\"MM\") IS NULL THEN 0 ELSE MAX(e.\"MM\") * 1 END + 1, 2, '0') AS \"MM\" FROM PRD_Y_PRO_PLAN_CONDITION e WHERE e.\"MM\" < '99'";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // PRD_Y_PRO_PLAN_CONDITIONの登録
        String sql = "UPDATE PRD_Y_PRO_PLAN_CONDITION\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM PRD_Y_PRO_PLAN_CONDITION WHERE " + getWhere();
