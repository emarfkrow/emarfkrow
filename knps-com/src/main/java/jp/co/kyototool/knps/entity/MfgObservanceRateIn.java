 ...
 * @author emarfkrow
 */
public class MfgObservanceRateIn implements IEntity {
    ...
    public static MfgObservanceRateIn get(final Object param1, final Object param2, final Object param3) {
        ...
        return Queries.get(sql, params, MfgObservanceRateIn.class);
    }

    /**
     * MFG_OBSERVANCE_RATE_IN追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        if (this.mfgObservanceRateOut != null) {
            this.mfgObservanceRateOut.setYyyy(this.getYyyy());
            this.mfgObservanceRateOut.setMm(this.getMm());
            this.mfgObservanceRateOut.setWcCode(this.getWcCode());
            this.mfgObservanceRateOut.insert(now, id);
        }
        ...
        String sql = "INSERT INTO MFG_OBSERVANCE_RATE_IN(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT LPAD (CASE WHEN MAX(e.WC_CODE) IS NULL THEN 0 ELSE MAX(e.WC_CODE) * 1 END + 1, 3, '0') AS WC_CODE FROM MFG_OBSERVANCE_RATE_IN e WHERE e.WC_CODE < '999'";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // MFG_OBSERVANCE_RATE_OUTの登録
        if (this.mfgObservanceRateOut != null) {
            mfgObservanceRateOut.setYyyy(this.getYyyy());
            mfgObservanceRateOut.setMm(this.getMm());
            mfgObservanceRateOut.setWcCode(this.getWcCode());
            try {
                mfgObservanceRateOut.insert(now, id);
            } catch (Exception e) {
                mfgObservanceRateOut.update(now, id);
            }
        }
        ...
        // MFG_OBSERVANCE_RATE_INの登録
        String sql = "UPDATE MFG_OBSERVANCE_RATE_IN\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    private String getSet() {
        ...
        setList.add("late_m5over = :late_m5over");
        ...
        setList.add("late_p20over = :late_p20over");
    ...
    public int delete() {
        ...
        if (this.mfgObservanceRateOut != null) {
            this.mfgObservanceRateOut.delete();
        }
        ...
        String sql = "DELETE FROM MFG_OBSERVANCE_RATE_IN WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String id) {
        ...
        params.put("LATE_M5OVER", this.lateM5Over);
        ...
        params.put("LATE_P20OVER", this.lateP20Over);
     ...
     */
    private MfgObservanceRateOut mfgObservanceRateOut;

    /**
     * @return MFG_OBSERVANCE_RATE_OUT
     */
    @com.fasterxml.jackson.annotation.JsonProperty("MfgObservanceRateOut")
    public MfgObservanceRateOut getMfgObservanceRateOut() {
        return this.mfgObservanceRateOut;
    }

    /**
     * @param p MFG_OBSERVANCE_RATE_OUT
     */
    public void setMfgObservanceRateOut(final MfgObservanceRateOut p) {
        this.mfgObservanceRateOut = p;
    }

    /**
     * @return MFG_OBSERVANCE_RATE_OUT
     */
    public MfgObservanceRateOut referMfgObservanceRateOut() {
        if (this.mfgObservanceRateOut == null) {
            try {
                this.mfgObservanceRateOut = MfgObservanceRateOut.get(this.yyyy, this.mm, this.wcCode);
