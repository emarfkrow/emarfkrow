...
/**
 * MFG_TOTAL_COST_REG_LINE_M登録フォーム
 *
 * @author emarfkrow
 */
public class MfgTotalCostRegLineMRegistForm implements IForm {
    ...
    @jakarta.validation.constraints.Size(max = 9)
    private String grossSumCostFirst;

    /**
     * @return GROSS_SUM_COST_FIRST
     */
    public String getGrossSumCostFirst() {
        return grossSumCostFirst;
    }

    /**
     * @param p GROSS_SUM_COST_FIRST
     */
    public void setGrossSumCostFirst(final String p) {
        this.grossSumCostFirst = p;
    }

    /** GROSS_SUM_COST_SECOND */
    @jakarta.validation.constraints.Size(max = 9)
    private String grossSumCostSecond;

    /**
     * @return GROSS_SUM_COST_SECOND
     */
    public String getGrossSumCostSecond() {
        return grossSumCostSecond;
    }

    /**
     * @param p GROSS_SUM_COST_SECOND
     */
    public void setGrossSumCostSecond(final String p) {
        this.grossSumCostSecond = p;
    }

    /** TOTAL_GROSS_SUM_COST */
    @jakarta.validation.constraints.Size(max = 9)
    private String totalGrossSumCost;

    /**
     * @return TOTAL_GROSS_SUM_COST
     */
    public String getTotalGrossSumCost() {
        return totalGrossSumCost;
    }

    /**
     * @param p TOTAL_GROSS_SUM_COST
     */
    public void setTotalGrossSumCost(final String p) {
        this.totalGrossSumCost = p;
    }

    /** GROSS_SUM_UNIT_SUPPLY */
    @jakarta.validation.constraints.Size(max = 10)
    private String grossSumUnitSupply;

    /**
     * @return GROSS_SUM_UNIT_SUPPLY
     */
    public String getGrossSumUnitSupply() {
        return grossSumUnitSupply;
    }

    /**
     * @param p GROSS_SUM_UNIT_SUPPLY
     */
    public void setGrossSumUnitSupply(final String p) {
        this.grossSumUnitSupply = p;
    }

    /** T_GROSS_SUM_COST_FIRST */
    @jakarta.validation.constraints.Size(max = 9)
    private String tGrossSumCostFirst;

    /**
     * @return T_GROSS_SUM_COST_FIRST
     */
    public String getTGrossSumCostFirst() {
        return tGrossSumCostFirst;
    }

    /**
     * @param p T_GROSS_SUM_COST_FIRST
     */
    public void setTGrossSumCostFirst(final String p) {
        this.tGrossSumCostFirst = p;
    }

    /** T_GROSS_SUM_COST_SECOND */
    @jakarta.validation.constraints.Size(max = 9)
    private String tGrossSumCostSecond;

    /**
     * @return T_GROSS_SUM_COST_SECOND
     */
    public String getTGrossSumCostSecond() {
        return tGrossSumCostSecond;
    }

    /**
     * @param p T_GROSS_SUM_COST_SECOND
     */
    public void setTGrossSumCostSecond(final String p) {
        this.tGrossSumCostSecond = p;
    }

    /** T_TOTAL_GROSS_SUM_COST */
    @jakarta.validation.constraints.Size(max = 9)
    private String tTotalGrossSumCost;

    /**
     * @return T_TOTAL_GROSS_SUM_COST
     */
    public String getTTotalGrossSumCost() {
        return tTotalGrossSumCost;
    }

    /**
     * @param p T_TOTAL_GROSS_SUM_COST
     */
    public void setTTotalGrossSumCost(final String p) {
        this.tTotalGrossSumCost = p;
    }

    /** T_GROSS_SUM_UNIT_SUPPLY */
    @jakarta.validation.constraints.Size(max = 10)
    private String tGrossSumUnitSupply;

    /**
     * @return T_GROSS_SUM_UNIT_SUPPLY
     */
    public String getTGrossSumUnitSupply() {
        return tGrossSumUnitSupply;
    }

    /**
     * @param p T_GROSS_SUM_UNIT_SUPPLY
     */
    public void setTGrossSumUnitSupply(final String p) {
        this.tGrossSumUnitSupply = p;
    }

    /** MFG_TOTAL_COST_REG_LINE_M_Q */
    @jakarta.validation.Valid
    private MfgTotalCostRegLineMQRegistForm mfgTotalCostRegLineMQRegistForm;

    /**
     * @return MfgTotalCostRegLineMQRegistForm
     */
    public MfgTotalCostRegLineMQRegistForm getMfgTotalCostRegLineMQRegistForm() {
        return mfgTotalCostRegLineMQRegistForm;
    }
     ...
     * @param p
     */
    public void setMfgTotalCostRegLineMQRegistForm(final MfgTotalCostRegLineMQRegistForm p) {
        this.mfgTotalCostRegLineMQRegistForm = p;
    }
