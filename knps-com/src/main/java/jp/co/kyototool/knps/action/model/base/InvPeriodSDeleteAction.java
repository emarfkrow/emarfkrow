 ...
 * @author emarfkrow
 */
public class InvPeriodSDeleteAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("InvPeriodGrid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            InvPeriod e = FormValidator.toBean(InvPeriod.class.getName(), gridRow);
            if (e.delete() != 1) {
                throw new OptLockError("error.cant.delete");
            }
        }
