 ...
 * @author emarfkrow
 */
public class MfgRateQ implements IEntity {
    ...
    public static MfgRateQ get(final Object param1) {
        ...
        return Queries.get(sql, params, MfgRateQ.class);
    }
    ...
    public int delete() {
        ...
        // MFG_RATE_Qの削除
        String sql = "DELETE FROM MFG_RATE_Q WHERE " + getWhere();
