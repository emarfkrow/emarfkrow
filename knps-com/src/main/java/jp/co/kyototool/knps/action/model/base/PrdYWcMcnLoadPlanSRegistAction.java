...
/**
 * PRD_Y_WC_MCN_LOAD_PLAN一覧登録
 *
 * @author emarfkrow
 */
public class PrdYWcMcnLoadPlanSRegistAction extends BaseAction {

    /** PRD_Y_WC_MCN_LOAD_PLAN一覧登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("PrdYWcMcnLoadPlanGrid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            PrdYWcMcnLoadPlan e = FormValidator.toBean(PrdYWcMcnLoadPlan.class.getName(), gridRow);
