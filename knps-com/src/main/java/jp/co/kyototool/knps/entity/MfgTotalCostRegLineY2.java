...
/**
 * MFG_TOTAL_COST_REG_LINE_Y2
 *
 * @author emarfkrow
 */
public class MfgTotalCostRegLineY2 implements IEntity {
     ...
     * @param param1 HINBAN
     * @param param2 YY
     * @param param3 PRO_GROUP_NO
     * @param param4 ROUTING
     * @return MFG_TOTAL_COST_REG_LINE_Y2
     */
    public static MfgTotalCostRegLineY2 get(final Object param1, final Object param2, final Object param3, final Object param4) {
        ...
        String sql = "SELECT * FROM MFG_TOTAL_COST_REG_LINE_Y2 WHERE " + String.join(" AND ", whereList);

        Map<String, Object> params = new HashMap<String, Object>();
        params.put("hinban", param1);
        params.put("yy", param2);
        params.put("pro_group_no", param3);
        params.put("routing", param4);

        return Queries.get(sql, params, MfgTotalCostRegLineY2.class);
    }

    /**
     * MFG_TOTAL_COST_REG_LINE_Y2追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        String sql = "INSERT INTO MFG_TOTAL_COST_REG_LINE_Y2(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // MFG_TOTAL_COST_REG_LINE_Y2の登録
        String sql = "UPDATE MFG_TOTAL_COST_REG_LINE_Y2\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    /**
     * MFG_TOTAL_COST_REG_LINE_Y2削除
     *
     * @return 削除件数
     */
    public int delete() {

        // MFG_TOTAL_COST_REG_LINE_Y2の削除
        String sql = "DELETE FROM MFG_TOTAL_COST_REG_LINE_Y2 WHERE " + getWhere();
