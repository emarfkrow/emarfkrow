...
/**
 * PRD_W_NES_KANBAN登録フォーム
 *
 * @author emarfkrow
 */
public class PrdWNesKanbanRegistForm implements IForm {
    ...
    private PrdWNesKanbanOldRegistForm prdWNesKanbanOldRegistForm;

    /**
     * @return PrdWNesKanbanOldRegistForm
     */
    public PrdWNesKanbanOldRegistForm getPrdWNesKanbanOldRegistForm() {
        return prdWNesKanbanOldRegistForm;
    }
     ...
     * @param p
     */
    public void setPrdWNesKanbanOldRegistForm(final PrdWNesKanbanOldRegistForm p) {
        this.prdWNesKanbanOldRegistForm = p;
    }
