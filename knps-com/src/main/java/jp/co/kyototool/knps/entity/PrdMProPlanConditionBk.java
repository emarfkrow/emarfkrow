...
/**
 * PRD_M_PRO_PLAN_CONDITION_BK
 *
 * @author emarfkrow
 */
public class PrdMProPlanConditionBk implements IEntity {
     ...
     * @return FIXED_STATUS
     */
    @com.fasterxml.jackson.annotation.JsonProperty("FIXED_STATUS")
     ...
     *
     * @return PRD_M_PRO_PLAN_CONDITION_BK
     */
    public static PrdMProPlanConditionBk get() {

        List<String> whereList = new ArrayList<String>();

        String sql = "SELECT * FROM PRD_M_PRO_PLAN_CONDITION_BK WHERE " + String.join(" AND ", whereList);

        Map<String, Object> params = new HashMap<String, Object>();

        return Queries.get(sql, params, PrdMProPlanConditionBk.class);
    }

    /**
     * PRD_M_PRO_PLAN_CONDITION_BK追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        // PRD_M_PRO_PLAN_CONDITION_BKの登録
        ...
        String sql = "INSERT INTO PRD_M_PRO_PLAN_CONDITION_BK(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // PRD_M_PRO_PLAN_CONDITION_BKの登録
        String sql = "UPDATE PRD_M_PRO_PLAN_CONDITION_BK\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    /**
     * PRD_M_PRO_PLAN_CONDITION_BK削除
     *
     * @return 削除件数
     */
    public int delete() {

        // PRD_M_PRO_PLAN_CONDITION_BKの削除
        String sql = "DELETE FROM PRD_M_PRO_PLAN_CONDITION_BK WHERE " + getWhere();
