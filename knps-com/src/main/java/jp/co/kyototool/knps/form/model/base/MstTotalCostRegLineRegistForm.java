...
/**
 * MST_TOTAL_COST_REG_LINE登録フォーム
 *
 * @author emarfkrow
 */
public class MstTotalCostRegLineRegistForm implements IForm {
    ...
    private MstTotalCostRegLineQRegistForm mstTotalCostRegLineQRegistForm;

    /**
     * @return MstTotalCostRegLineQRegistForm
     */
    public MstTotalCostRegLineQRegistForm getMstTotalCostRegLineQRegistForm() {
        return mstTotalCostRegLineQRegistForm;
    }
     ...
     * @param p
     */
    public void setMstTotalCostRegLineQRegistForm(final MstTotalCostRegLineQRegistForm p) {
        this.mstTotalCostRegLineQRegistForm = p;
    }

    /** MFG_TOTAL_COST_REG_LINE_Y */
    @jakarta.validation.Valid
    private List<MfgTotalCostRegLineYRegistForm> mfgTotalCostRegLineYGrid;

    /**
     * @return MFG_TOTAL_COST_REG_LINE_Y
     */
    public List<MfgTotalCostRegLineYRegistForm> getMfgTotalCostRegLineYGrid() {
        return mfgTotalCostRegLineYGrid;
    }

    /**
     * @param p
     */
    public void setMfgTotalCostRegLineYGrid(final List<MfgTotalCostRegLineYRegistForm> p) {
        this.mfgTotalCostRegLineYGrid = p;
    }
