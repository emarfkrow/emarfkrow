 ...
 * @author emarfkrow
 */
public class PrdStoreMainteReportDeleteAction extends BaseAction {

    /** PRD_STORE_MAINTE_REPORT削除処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        PrdStoreMainteReport e = FormValidator.toBean(PrdStoreMainteReport.class.getName(), postJson);
        if (e.delete() != 1) {
            throw new OptLockError("error.cant.delete");
        }
