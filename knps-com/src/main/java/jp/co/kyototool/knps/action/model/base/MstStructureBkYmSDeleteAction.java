...
/**
 * MST_STRUCTURE_BK_YM一覧削除
 *
 * @author emarfkrow
 */
public class MstStructureBkYmSDeleteAction extends BaseAction {

    /** MST_STRUCTURE_BK_YM一覧削除処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("MstStructureBkYmGrid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            MstStructureBkYm e = FormValidator.toBean(MstStructureBkYm.class.getName(), gridRow);
            if (e.delete() != 1) {
                throw new OptLockError("error.cant.delete");
            }
        }
