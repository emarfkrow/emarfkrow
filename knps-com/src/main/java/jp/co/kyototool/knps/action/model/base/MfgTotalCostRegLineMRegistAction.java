...
/**
 * MFG_TOTAL_COST_REG_LINE_M登録
 *
 * @author emarfkrow
 */
public class MfgTotalCostRegLineMRegistAction extends BaseAction {

    /** MFG_TOTAL_COST_REG_LINE_M登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {

        Map<String, Object> map = new HashMap<String, Object>();

        MfgTotalCostRegLineM e = FormValidator.toBean(MfgTotalCostRegLineM.class.getName(), postJson);
