...
/**
 * INV_STOCK_PROCESS_SUPPLY
 *
 * @author emarfkrow
 */
public class InvStockProcessSupply implements IEntity {
    ...
    /** SHIKYU_QT */
    private java.math.BigDecimal shikyuQt;

    /**
     * @return SHIKYU_QT
     */
    public java.math.BigDecimal getShikyuQt() {
        return this.shikyuQt;
    }

    /**
     * @param o SHIKYU_QT
     */
    public void setShikyuQt(final Object o) {
        if (!jp.co.golorp.emarf.lang.StringUtil.isNullOrBlank(o)) {
            this.shikyuQt = new java.math.BigDecimal(o.toString());
        } else {
            this.shikyuQt = null;
        }
    }
     ...
     * @param param2 HINBAN
     * @return INV_STOCK_PROCESS_SUPPLY
     */
    public static InvStockProcessSupply get(final Object param1, final Object param2) {
        ...
        return Queries.get(sql, params, InvStockProcessSupply.class);
    }

    /**
     * INV_STOCK_PROCESS_SUPPLY追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // INV_STOCK_PROCESS_SUPPLYの登録
        String sql = "UPDATE INV_STOCK_PROCESS_SUPPLY\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM INV_STOCK_PROCESS_SUPPLY WHERE " + getWhere();
