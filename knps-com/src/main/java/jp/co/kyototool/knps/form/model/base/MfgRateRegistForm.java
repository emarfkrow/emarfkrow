 ...
 * @author emarfkrow
 */
public class MfgRateRegistForm implements IForm {
    ...
    private MfgRateQRegistForm mfgRateQRegistForm;

    /**
     * @return MfgRateQRegistForm
     */
    public MfgRateQRegistForm getMfgRateQRegistForm() {
        return mfgRateQRegistForm;
    }
     ...
     * @param p
     */
    public void setMfgRateQRegistForm(final MfgRateQRegistForm p) {
        this.mfgRateQRegistForm = p;
    }
