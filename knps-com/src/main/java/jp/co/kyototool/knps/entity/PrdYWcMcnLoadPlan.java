 ...
 * @author emarfkrow
 */
public class PrdYWcMcnLoadPlan implements IEntity {
     ...
     */
    public static PrdYWcMcnLoadPlan get(final Object param1, final Object param2, final Object param3, final Object param4) {
        ...
        String sql = "SELECT * FROM PRD_Y_WC_MCN_LOAD_PLAN WHERE " + String.join(" AND ", whereList);
        ...
        return Queries.get(sql, params, PrdYWcMcnLoadPlan.class);
    }

    /**
     * PRD_Y_WC_MCN_LOAD_PLAN追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // PRD_Y_WC_MCN_LOAD_PLANの登録
        String sql = "UPDATE PRD_Y_WC_MCN_LOAD_PLAN\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM PRD_Y_WC_MCN_LOAD_PLAN WHERE " + getWhere();
