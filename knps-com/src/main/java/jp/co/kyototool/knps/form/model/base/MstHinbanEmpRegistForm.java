...
/**
 * MST_HINBAN_EMP登録フォーム
 *
 * @author emarfkrow
 */
public class MstHinbanEmpRegistForm implements IForm {
    ...
    public String getHinbanOpeName() {
        return hinbanOpeName;
    }

    /**
     * @param p HINBAN_OPE_NAME
     */
    public void setHinbanOpeName(final String p) {
        this.hinbanOpeName = p;
    }
