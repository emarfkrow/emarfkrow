...
/**
 * PRD_Y_WS_MAN_LOAD_PLAN一覧登録
 *
 * @author emarfkrow
 */
public class PrdYWsManLoadPlanSRegistAction extends BaseAction {

    /** PRD_Y_WS_MAN_LOAD_PLAN一覧登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("PrdYWsManLoadPlanGrid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            PrdYWsManLoadPlan e = FormValidator.toBean(PrdYWsManLoadPlan.class.getName(), gridRow);
