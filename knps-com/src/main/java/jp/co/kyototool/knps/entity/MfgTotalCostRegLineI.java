...
/**
 * MFG_TOTAL_COST_REG_LINE_I
 *
 * @author emarfkrow
 */
public class MfgTotalCostRegLineI implements IEntity {
     ...
     * @param param4 YY
     * @param param5 MM
     * @return MFG_TOTAL_COST_REG_LINE_I
     */
    public static MfgTotalCostRegLineI get(final Object param1, final Object param2, final Object param3, final Object param4, final Object param5) {
        ...
        return Queries.get(sql, params, MfgTotalCostRegLineI.class);
    }

    /**
     * MFG_TOTAL_COST_REG_LINE_I追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        if (this.mfgTotalCostRegLineIQ != null) {
            this.mfgTotalCostRegLineIQ.setHinban(this.getHinban());
            this.mfgTotalCostRegLineIQ.setProGroupNo(this.getProGroupNo());
            this.mfgTotalCostRegLineIQ.setRouting(this.getRouting());
            this.mfgTotalCostRegLineIQ.setYy(this.getYy());
            this.mfgTotalCostRegLineIQ.setMm(this.getMm());
            this.mfgTotalCostRegLineIQ.insert(now, id);
        }
        ...
        String sql = "INSERT INTO MFG_TOTAL_COST_REG_LINE_I(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT LPAD (CASE WHEN MAX(e.\"MM\") IS NULL THEN 0 ELSE MAX(e.\"MM\") * 1 END + 1, 2, '0') AS \"MM\" FROM MFG_TOTAL_COST_REG_LINE_I e WHERE e.\"MM\" < '99'";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // MFG_TOTAL_COST_REG_LINE_I_Qの登録
        if (this.mfgTotalCostRegLineIQ != null) {
            mfgTotalCostRegLineIQ.setHinban(this.getHinban());
            mfgTotalCostRegLineIQ.setProGroupNo(this.getProGroupNo());
            mfgTotalCostRegLineIQ.setRouting(this.getRouting());
            mfgTotalCostRegLineIQ.setYy(this.getYy());
            mfgTotalCostRegLineIQ.setMm(this.getMm());
            try {
                mfgTotalCostRegLineIQ.insert(now, id);
            } catch (Exception e) {
                mfgTotalCostRegLineIQ.update(now, id);
            }
        }
        ...
        // MFG_TOTAL_COST_REG_LINE_Iの登録
        String sql = "UPDATE MFG_TOTAL_COST_REG_LINE_I\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        if (this.mfgTotalCostRegLineIQ != null) {
            this.mfgTotalCostRegLineIQ.delete();
        }
        ...
        String sql = "DELETE FROM MFG_TOTAL_COST_REG_LINE_I WHERE " + getWhere();
     ...
     */
    private MfgTotalCostRegLineIQ mfgTotalCostRegLineIQ;

    /**
     * @return MFG_TOTAL_COST_REG_LINE_I_Q
     */
    @com.fasterxml.jackson.annotation.JsonProperty("MfgTotalCostRegLineIQ")
    public MfgTotalCostRegLineIQ getMfgTotalCostRegLineIQ() {
        return this.mfgTotalCostRegLineIQ;
    }

    /**
     * @param p MFG_TOTAL_COST_REG_LINE_I_Q
     */
    public void setMfgTotalCostRegLineIQ(final MfgTotalCostRegLineIQ p) {
        this.mfgTotalCostRegLineIQ = p;
    }

    /**
     * @return MFG_TOTAL_COST_REG_LINE_I_Q
     */
    public MfgTotalCostRegLineIQ referMfgTotalCostRegLineIQ() {
        if (this.mfgTotalCostRegLineIQ == null) {
            try {
                this.mfgTotalCostRegLineIQ = MfgTotalCostRegLineIQ.get(this.hinban, this.proGroupNo, this.routing, this.yy, this.mm);
