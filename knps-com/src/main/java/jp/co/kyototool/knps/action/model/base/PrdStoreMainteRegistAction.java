 ...
 * @author emarfkrow
 */
public class PrdStoreMainteRegistAction extends BaseAction {

    /** PRD_STORE_MAINTE登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {

        Map<String, Object> map = new HashMap<String, Object>();

        PrdStoreMainte e = FormValidator.toBean(PrdStoreMainte.class.getName(), postJson);
