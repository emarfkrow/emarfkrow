...
/**
 * PRD_M_PRO_PLAN_ROUTING一覧登録
 *
 * @author emarfkrow
 */
public class PrdMProPlanRoutingSRegistAction extends BaseAction {

    /** PRD_M_PRO_PLAN_ROUTING一覧登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("PrdMProPlanRoutingGrid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            PrdMProPlanRouting e = FormValidator.toBean(PrdMProPlanRouting.class.getName(), gridRow);
