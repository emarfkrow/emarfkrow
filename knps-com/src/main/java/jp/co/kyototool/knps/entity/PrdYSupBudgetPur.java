 ...
 * @author emarfkrow
 */
public class PrdYSupBudgetPur implements IEntity {
    ...
    public static PrdYSupBudgetPur get(final Object param1, final Object param2, final Object param3, final Object param4) {
        ...
        return Queries.get(sql, params, PrdYSupBudgetPur.class);
    }

    /**
     * PRD_Y_SUP_BUDGET_PUR追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        String sql = "INSERT INTO PRD_Y_SUP_BUDGET_PUR(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT LPAD (CASE WHEN MAX(e.SUP_CODE) IS NULL THEN 0 ELSE MAX(e.SUP_CODE) * 1 END + 1, 6, '0') AS SUP_CODE FROM PRD_Y_SUP_BUDGET_PUR e WHERE e.SUP_CODE < '999999'";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // PRD_Y_SUP_BUDGET_PURの登録
        String sql = "UPDATE PRD_Y_SUP_BUDGET_PUR\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM PRD_Y_SUP_BUDGET_PUR WHERE " + getWhere();
