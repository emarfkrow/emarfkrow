...
/**
 * MFG_TOTAL_COST_REG_LINE_Y2登録
 *
 * @author emarfkrow
 */
public class MfgTotalCostRegLineY2RegistAction extends BaseAction {

    /** MFG_TOTAL_COST_REG_LINE_Y2登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {

        Map<String, Object> map = new HashMap<String, Object>();

        MfgTotalCostRegLineY2 e = FormValidator.toBean(MfgTotalCostRegLineY2.class.getName(), postJson);
