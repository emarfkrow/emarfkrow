 ...
 * @author emarfkrow
 */
public class MstStructureBkRegistAction extends BaseAction {

    /** MST_STRUCTURE_BK登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {

        Map<String, Object> map = new HashMap<String, Object>();

        MstStructureBk e = FormValidator.toBean(MstStructureBk.class.getName(), postJson);
