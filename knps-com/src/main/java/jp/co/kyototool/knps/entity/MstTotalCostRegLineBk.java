 ...
 * @author emarfkrow
 */
public class MstTotalCostRegLineBk implements IEntity {
     ...
     */
    public static MstTotalCostRegLineBk get(final Object param1, final Object param2, final Object param3, final Object param4) {
        ...
        String sql = "SELECT * FROM MST_TOTAL_COST_REG_LINE_BK WHERE " + String.join(" AND ", whereList);
        ...
        return Queries.get(sql, params, MstTotalCostRegLineBk.class);
    }

    /**
     * MST_TOTAL_COST_REG_LINE_BK追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        String sql = "INSERT INTO MST_TOTAL_COST_REG_LINE_BK(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT LPAD (CASE WHEN MAX(e.\"YY\") IS NULL THEN 0 ELSE MAX(e.\"YY\") * 1 END + 1, 4, '0') AS \"YY\" FROM MST_TOTAL_COST_REG_LINE_BK e WHERE e.\"YY\" < '9999'";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // MST_TOTAL_COST_REG_LINE_BKの登録
        String sql = "UPDATE MST_TOTAL_COST_REG_LINE_BK\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM MST_TOTAL_COST_REG_LINE_BK WHERE " + getWhere();
