...
/**
 * MFG_OBSERVANCE_RATE_IN登録
 *
 * @author emarfkrow
 */
public class MfgObservanceRateInRegistAction extends BaseAction {

    /** MFG_OBSERVANCE_RATE_IN登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {

        Map<String, Object> map = new HashMap<String, Object>();

        MfgObservanceRateIn e = FormValidator.toBean(MfgObservanceRateIn.class.getName(), postJson);
