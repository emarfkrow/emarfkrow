...
/**
 * PRD_TEHAI_IRAI_DET_HIS
 *
 * @author emarfkrow
 */
public class PrdTehaiIraiDetHis implements IEntity {
    ...
    /** IRAI_DET_HIS_SEQ */
    private java.math.BigDecimal iraiDetHisSeq;

    /**
     * @return IRAI_DET_HIS_SEQ
     */
    @com.fasterxml.jackson.annotation.JsonProperty("IRAI_DET_HIS_SEQ")
    public java.math.BigDecimal getIraiDetHisSeq() {
        return this.iraiDetHisSeq;
    }

    /**
     * @param o IRAI_DET_HIS_SEQ
     */
    public void setIraiDetHisSeq(final Object o) {
        if (!jp.co.golorp.emarf.lang.StringUtil.isNullOrBlank(o)) {
            this.iraiDetHisSeq = new java.math.BigDecimal(o.toString());
        } else {
            this.iraiDetHisSeq = null;
        }
    }
     ...
     * @param param3 IRAI_DET_HIS_SEQ
     * @return PRD_TEHAI_IRAI_DET_HIS
     */
    public static PrdTehaiIraiDetHis get(final Object param1, final Object param2, final Object param3) {
        ...
        params.put("irai_det_his_seq", param3);

        return Queries.get(sql, params, PrdTehaiIraiDetHis.class);
    }

    /**
     * PRD_TEHAI_IRAI_DET_HIS追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    private String getValues() {
        ...
        valueList.add(":irai_det_his_seq");
        valueList.add(":id");
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // PRD_TEHAI_IRAI_DET_HISの登録
        String sql = "UPDATE PRD_TEHAI_IRAI_DET_HIS\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM PRD_TEHAI_IRAI_DET_HIS WHERE " + getWhere();
