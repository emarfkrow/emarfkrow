 ...
 * @author emarfkrow
 */
public class PrdRackMainte implements IEntity {
    ...
    /** RACK_NES_COUNTS */
    private java.math.BigDecimal rackNesCounts;
    ...
    /**
     * @param o RACK_NES_COUNTS
     */
    public void setRackNesCounts(final Object o) {
        if (!jp.co.golorp.emarf.lang.StringUtil.isNullOrBlank(o)) {
            this.rackNesCounts = new java.math.BigDecimal(o.toString());
        } else {
            this.rackNesCounts = null;
        }
    }
    ...
    public static PrdRackMainte get(final Object param1, final Object param2, final Object param3) {
        ...
        params.put("rack_name", param3);

        return Queries.get(sql, params, PrdRackMainte.class);
    }
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        nameList.add("rack_nes_counts -- :rack_nes_counts");
        ...
        String sql = "INSERT INTO PRD_RACK_MAINTE(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // PRD_RACK_MAINTEの登録
        String sql = "UPDATE PRD_RACK_MAINTE\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    private String getSet() {
        ...
        setList.add("rack_nes_counts = :rack_nes_counts");
    ...
    public int delete() {
        ...
        // PRD_RACK_MAINTEの削除
        String sql = "DELETE FROM PRD_RACK_MAINTE WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String id) {
        ...
        params.put("RACK_NES_COUNTS", this.rackNesCounts);
