...
/**
 * MFG_TOTAL_COST_REG_LINE_I登録
 *
 * @author emarfkrow
 */
public class MfgTotalCostRegLineIRegistAction extends BaseAction {

    /** MFG_TOTAL_COST_REG_LINE_I登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {

        Map<String, Object> map = new HashMap<String, Object>();

        MfgTotalCostRegLineI e = FormValidator.toBean(MfgTotalCostRegLineI.class.getName(), postJson);
