 ...
 * @author emarfkrow
 */
public class PrdMProNesCounts implements IEntity {
    ...
    public static PrdMProNesCounts get(final Object param1, final Object param2, final Object param3) {
        ...
        return Queries.get(sql, params, PrdMProNesCounts.class);
    }

    /**
     * PRD_M_PRO_NES_COUNTS追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        String sql = "INSERT INTO PRD_M_PRO_NES_COUNTS(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT LPAD (CASE WHEN MAX(e.\"MM\") IS NULL THEN 0 ELSE MAX(e.\"MM\") * 1 END + 1, 2, '0') AS \"MM\" FROM PRD_M_PRO_NES_COUNTS e WHERE e.\"MM\" < '99'";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // PRD_M_PRO_NES_COUNTSの登録
        String sql = "UPDATE PRD_M_PRO_NES_COUNTS\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM PRD_M_PRO_NES_COUNTS WHERE " + getWhere();
