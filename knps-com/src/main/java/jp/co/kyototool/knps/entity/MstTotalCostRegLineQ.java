 ...
 * @author emarfkrow
 */
public class MstTotalCostRegLineQ implements IEntity {
    ...
    public static MstTotalCostRegLineQ get(final Object param1, final Object param2, final Object param3) {
        ...
        return Queries.get(sql, params, MstTotalCostRegLineQ.class);
    }

    /**
     * MST_TOTAL_COST_REG_LINE_Q追加
     *
     * @param now システム日時
     * @param id 登録者
     * @return 追加件数
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        String sql = "INSERT INTO MST_TOTAL_COST_REG_LINE_Q(\r\n      " + name + "\r\n) VALUES (\r\n      " + getValues() + "\r\n)";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        // MST_TOTAL_COST_REG_LINE_Qの登録
        String sql = "UPDATE MST_TOTAL_COST_REG_LINE_Q\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        Map<String, Object> params = toMap(now, id);
        return Queries.regist(sql, params);
    }
    ...
    public int delete() {
        ...
        String sql = "DELETE FROM MST_TOTAL_COST_REG_LINE_Q WHERE " + getWhere();
