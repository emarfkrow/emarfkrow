...
/**
 * PRD_M_SUP_BUDGET_PUR登録フォーム
 *
 * @author emarfkrow
 */
public class PrdMSupBudgetPurRegistForm implements IForm {
    ...
    private PrdYSupBudgetPurRegistForm prdYSupBudgetPurRegistForm;

    /**
     * @return PrdYSupBudgetPurRegistForm
     */
    public PrdYSupBudgetPurRegistForm getPrdYSupBudgetPurRegistForm() {
        return prdYSupBudgetPurRegistForm;
    }
     ...
     * @param p
     */
    public void setPrdYSupBudgetPurRegistForm(final PrdYSupBudgetPurRegistForm p) {
        this.prdYSupBudgetPurRegistForm = p;
    }
