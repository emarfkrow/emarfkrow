...
/**
 * HKTC_PRD_DAILY_PRO_PLAN登録フォーム
 *
 * @author emarfkrow
 */
public class HktcPrdDailyProPlanRegistForm implements IForm {
     ...
     * @param p UPDATE_DATE
     */
    public void setUpdateDate(final String p) {
        this.updateDate = p;
    }

    /** PRD_DAILY_PRO_PLAN */
    @jakarta.validation.Valid
    private PrdDailyProPlanRegistForm prdDailyProPlanRegistForm;

    /**
     * @return PrdDailyProPlanRegistForm
     */
    public PrdDailyProPlanRegistForm getPrdDailyProPlanRegistForm() {
        return prdDailyProPlanRegistForm;
    }
     ...
     * @param p
     */
    public void setPrdDailyProPlanRegistForm(final PrdDailyProPlanRegistForm p) {
        this.prdDailyProPlanRegistForm = p;
    }
