...
/**
 * INV_STOCK_MANAGEMENT_INV_DET_M一覧登録
 *
 * @author emarfkrow
 */
public class InvStockManagementInvDetMSRegistAction extends BaseAction {

    /** INV_STOCK_MANAGEMENT_INV_DET_M一覧登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("InvStockManagementInvDetMGrid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            InvStockManagementInvDetM e = FormValidator.toBean(InvStockManagementInvDetM.class.getName(), gridRow);
            ...
            if (jp.co.golorp.emarf.lang.StringUtil.isNullOrBlank(e.getInvBranchNo())) {
                isNew = true;
            }
