...
/**
 * MFG_TOTAL_COST_REG_LINE_Y登録フォーム
 *
 * @author emarfkrow
 */
public class MfgTotalCostRegLineYRegistForm implements IForm {

    /** logger */
    private static final Logger LOG = LoggerFactory.getLogger(MfgTotalCostRegLineYRegistForm.class);
    ...
    private MstTotalCostRegLineBkRegistForm mstTotalCostRegLineBkRegistForm;

    /**
     * @return MstTotalCostRegLineBkRegistForm
     */
    public MstTotalCostRegLineBkRegistForm getMstTotalCostRegLineBkRegistForm() {
        return mstTotalCostRegLineBkRegistForm;
    }
     ...
     * @param p
     */
    public void setMstTotalCostRegLineBkRegistForm(final MstTotalCostRegLineBkRegistForm p) {
        this.mstTotalCostRegLineBkRegistForm = p;
    }
