...
/**
 * MFG_TOTAL_COST_REG_LINE_I登録フォーム
 *
 * @author emarfkrow
 */
public class MfgTotalCostRegLineIRegistForm implements IForm {
    ...
    private MfgTotalCostRegLineIQRegistForm mfgTotalCostRegLineIQRegistForm;

    /**
     * @return MfgTotalCostRegLineIQRegistForm
     */
    public MfgTotalCostRegLineIQRegistForm getMfgTotalCostRegLineIQRegistForm() {
        return mfgTotalCostRegLineIQRegistForm;
    }
     ...
     * @param p
     */
    public void setMfgTotalCostRegLineIQRegistForm(final MfgTotalCostRegLineIQRegistForm p) {
        this.mfgTotalCostRegLineIQRegistForm = p;
    }

    /** MFG_TOTAL_COST_REG_LINE_M */
    @jakarta.validation.Valid
    private MfgTotalCostRegLineMRegistForm mfgTotalCostRegLineMRegistForm;

    /**
     * @return MfgTotalCostRegLineMRegistForm
     */
    public MfgTotalCostRegLineMRegistForm getMfgTotalCostRegLineMRegistForm() {
        return mfgTotalCostRegLineMRegistForm;
    }
     ...
     * @param p
     */
    public void setMfgTotalCostRegLineMRegistForm(final MfgTotalCostRegLineMRegistForm p) {
        this.mfgTotalCostRegLineMRegistForm = p;
    }
