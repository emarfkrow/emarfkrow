...
/**
 * MFG_OBSERVANCE_RATE_OUT登録
 *
 * @author emarfkrow
 */
public class MfgObservanceRateOutRegistAction extends BaseAction {

    /** MFG_OBSERVANCE_RATE_OUT登録処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {

        Map<String, Object> map = new HashMap<String, Object>();

        MfgObservanceRateOut e = FormValidator.toBean(MfgObservanceRateOut.class.getName(), postJson);
