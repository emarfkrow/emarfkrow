 ...
 * @author emarfkrow
 */
public class MstTotalCostRegLineDeleteAction extends BaseAction {

    /** MST_TOTAL_COST_REG_LINE削除処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        MstTotalCostRegLine e = FormValidator.toBean(MstTotalCostRegLine.class.getName(), postJson);
        if (e.delete() != 1) {
            throw new OptLockError("error.cant.delete");
        }
