...
/**
 * PRD_M_WC_MCN_LOAD_PLAN登録フォーム
 *
 * @author emarfkrow
 */
public class PrdMWcMcnLoadPlanRegistForm implements IForm {
    ...
    private PrdYWcMcnLoadPlanRegistForm prdYWcMcnLoadPlanRegistForm;

    /**
     * @return PrdYWcMcnLoadPlanRegistForm
     */
    public PrdYWcMcnLoadPlanRegistForm getPrdYWcMcnLoadPlanRegistForm() {
        return prdYWcMcnLoadPlanRegistForm;
    }
     ...
     * @param p
     */
    public void setPrdYWcMcnLoadPlanRegistForm(final PrdYWcMcnLoadPlanRegistForm p) {
        this.prdYWcMcnLoadPlanRegistForm = p;
    }
