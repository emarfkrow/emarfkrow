 ...
 * @author emarfkrow
 */
public class PrdYProNesCountsGetAction extends BaseAction {

    /** PRD_Y_PRO_NES_COUNTS照会処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        PrdYProNesCounts prdYProNesCounts = PrdYProNesCounts.get(proHinban, yyyy, mm);
        map.put("PrdYProNesCounts", prdYProNesCounts);
        return map;
    }
