 ...
 * @author emarfkrow
 */
public class MstWc implements IEntity {
    ...
    public static MstWc get(final Object param1) {
        ...
        return Queries.get(sql, params, MstWc.class);
    }
    ...
    public int insert(final LocalDateTime now, final String id) {
        ...
        // MST_WC_BKの登録
        if (this.mstWcBks != null) {
            for (MstWcBk mstWcBk : this.mstWcBks) {
                mstWcBk.setWcCode(this.getWcCode());
                mstWcBk.insert(now, id);
            }
        }
    ...
    private void numbering() {
        ...
        String sql = "SELECT LPAD (CASE WHEN MAX(e.WC_CODE) IS NULL THEN 0 ELSE MAX(e.WC_CODE) * 1 END + 1, 3, '0') AS WC_CODE FROM MST_WC e WHERE e.WC_CODE < '999'";
    ...
    public int update(final LocalDateTime now, final String id) {
        ...
        if (this.mstWcBks != null) {
            for (MstWcBk mstWcBk : this.mstWcBks) {
                mstWcBk.setWcCode(this.wcCode);
                try {
                    mstWcBk.insert(now, id);
                } catch (Exception e) {
                    mstWcBk.update(now, id);
                }
            }
            this.mstWcBks = null;
            this.referMstWcBks();
            if (this.mstWcBks != null) {
                for (MstWcBk mstWcBk : this.mstWcBks) {
                    if (!mstWcBk.getTimeStampChange().equals(now)) {
                        mstWcBk.delete();
                    }
                }
            }
    ...
    public int delete() {
        ...
        // MST_WCの削除
        String sql = "DELETE FROM MST_WC WHERE " + getWhere();
     ...
     * MST_WC_BKのリスト
     */
    private List<MstWcBk> mstWcBks;

    /**
     * @return MST_WC_BKのリスト
     */
    @com.fasterxml.jackson.annotation.JsonProperty("MstWcBks")
    public List<MstWcBk> getMstWcBks() {
        return this.mstWcBks;
    }

    /**
     * @param list MST_WC_BKのリスト
     */
    public void setMstWcBks(final List<MstWcBk> list) {
        this.mstWcBks = list;
    }
     ...
     * @param mstWcBk
     */
    public void addMstWcBks(final MstWcBk mstWcBk) {
        if (this.mstWcBks == null) {
            this.mstWcBks = new ArrayList<MstWcBk>();
        }
        this.mstWcBks.add(mstWcBk);
    }

    /**
     * @return MST_WC_BKのリスト
     */
    public List<MstWcBk> referMstWcBks() {
        if (this.mstWcBks == null) {
            this.mstWcBks = MstWc.referMstWcBks(this.wcCode);
        }
        return this.mstWcBks;
    }
     ...
     * @return List<MstWcBk>
     */
    public static List<MstWcBk> referMstWcBks(final String param1) {
        ...
        return Queries.select(sql, params, MstWcBk.class);
    }
}
