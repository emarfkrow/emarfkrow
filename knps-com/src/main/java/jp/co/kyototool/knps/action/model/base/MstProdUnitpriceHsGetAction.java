 ...
 * @author emarfkrow
 */
public class MstProdUnitpriceHsGetAction extends BaseAction {

    /** MST_PROD_UNITPRICE_HS照会処理 */
    @Override
    public Map<String, Object> running(final LocalDateTime now, final String id, final Map<String, Object> postJson) {
        ...
        MstProdUnitpriceHs mstProdUnitpriceHs = MstProdUnitpriceHs.get(manHinban, routingGroup, routing, wcCode, minOrder, timeStampChange);
        map.put("MstProdUnitpriceHs", mstProdUnitpriceHs);
        return map;
    }
