...
(function($) {
    ...
    function DateEditor(args) {
        ...
        this.loadValue = function(item) {
            defaultValue = Formatter.Ymd(new Date(item[args.column.field] || ""));
    ...
    function CommaEditor(args) {
        ...
        this.init = function() {
            var navOnLR = args.grid.getOptions().editorCellNavOnLRKeys;
            $input = $("<INPUT type=number class='editor-text right' step=1 />")
                .appendTo(args.container)
                .on("keydown.nav", navOnLR ? handleKeydownLRNav : handleKeydownLRNoNav)
                .focus()
                .select();
    ...
    function BitEditor(args) {
        ...
        this.init = function() {
            var navOnLR = args.grid.getOptions().editorCellNavOnLRKeys;
            $input = $("<INPUT type=text class='editor-text right' step=1 />")
                .appendTo(args.container)
                .on("keydown.nav", navOnLR ? handleKeydownLRNav : handleKeydownLRNoNav)
                .focus()
                .select();
