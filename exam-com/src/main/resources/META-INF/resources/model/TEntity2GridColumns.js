...
let TEntity2GridColumns = [
    ...
    Column.text('SURYO_QT', Messages['TEntity2Grid.suryoQt'], 90, '', null),
    Column.text('TANKA_AM', Messages['TEntity2Grid.tankaAm'], 110, '', null),
    Column.text('KINGAKU_AM', Messages['TEntity2Grid.kingakuAm'], 110, '', null),
